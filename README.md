...
- 🏆 **Меню для настройки Титулов** - кастомизация заголовков и подзаголовков
...
description: "Выберите стиль для ваших титулов"
type: "title"

options:
  header: "&6&lДобро пожаловать!"
  subtitle: "&7На сервер!"
  timing: "normal"
  effect: "fadein"
...
Готовый плагин будет в файле `build/libs/CustomUI-1.0.0.jar`
