...
- 📝 **PlaceholderAPI поддержка** - полная интеграция с PlaceholderAPI
- 🛡️ **LuckPerms интеграция** - работа с правами и группами
...
- **PlaceholderAPI** - для поддержки плейсхолдеров (рекомендуется)
- **LuckPerms** - для работы с правами и группами (рекомендуется)
